...
public class FabricBlockCommandModule extends AbstractBlockCommandModule {
    ...
    public static void registerCommands(CommandDispatcher<CommandSourceStack> dispatcher) {
        ...
        dispatcher.register(Commands.literal("blockcommands")
                ...
                .then(Commands.literal("add")
                    .then(Commands.argument("command", StringArgumentType.greedyString())
                        .executes(ctx -> {
                            ...
                            FabricBlockCommandModule mod = MidnightCoreAPI.getModule(FabricBlockCommandModule.class);
                            BlockCommandRegistry reg = mod.findRegistry(ConversionUtil.toIdentifier(ctx.getSource().getLevel().dimension().location()));
                            if (reg == null) {
    ...
    public static final ModuleInfo<MidnightCoreAPI, Module<MidnightCoreAPI>> MODULE_INFO = new ModuleInfo<>(FabricBlockCommandModule::new, ID, DEFAULT_CONFIG);
}
